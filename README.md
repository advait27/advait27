...
<picture>
  ...
  <img alt="Advait Dharmadhikari — Forward Deployed AI Engineer. Agentic systems, RAG, LLM evaluation, enterprise deployment. Dublin, Ireland." src="svg/hero-light.svg" width="880">
</picture>
</p>
...
<br><samp>Dec 2025 – present · Dublin</samp>
...
<picture>
  ...
  <img alt="Contribution totals for the last 365 days, with a weekly area chart." src="svg/pulse-light.svg" width="880">
</picture>
</p>
...
<picture>
  ...
  <img alt="A year of contributions, one cell per day." src="svg/year-light.svg" width="880">
</picture>
</p>
...
<picture>
  ...
  <img alt="Most recently pushed repositories." src="svg/now-light.svg" width="880">
</picture>
</p>

<details>
<summary>The same numbers as text</summary>
...
<br>First-author preprint establishing Forward Deployed Engineering as a
...
<br>First-author paper and open benchmark testing whether agent runtime records
...
<br>Context engineering, enterprise agent architecture and reliability, AI
...
<br>A governed multi-agent platform that investigates business questions
...
data.
<br><samp>Python · FastAPI · LangGraph-pattern orchestration · Postgres (RLS) · Qdrant · Neo4j · Redis · NL-to-SQL safety gate · OpenTelemetry</samp>

**[Veritas](https://github.com/advait27/Veritas) — self-hosted MCP server**
<br>Turns Claude into a hypothesis-driven data investigator: builds and
...
<br><samp>Python · MCP · DuckDB · Claude Desktop / Claude Code · Docker · pytest / mypy / ruff</samp>

**ClawbackVault AI** *(Frensei, production)*
<br>Privacy-first signal intelligence for broker-dealers — targeted-surveillance
...
**Founding AI Engineer & Product Lead** — Frensei Innovation Labs (ClawbackVault AI)
<br><samp>Dec 2025 – present · Dublin, Ireland</samp>

**Business Analyst & ML Engineer** — IndiGo (InterGlobe Aviation)
<br><samp>Jan 2024 – Aug 2025 · Gurugram, India</samp>
<br>ML-driven optimization and decision intelligence across a 300+ aircraft
...
<br><samp>Jun 2023 – Dec 2023 · Gurugram, India</samp>

**Business Development Analyst, Team Lead** — CHRIST Consulting
<br><samp>Jun 2021 – Jun 2022 · India</samp>
<br>Led a 15-member analyst team across market-entry and growth-strategy
...
<br><samp>Jan – May 2026</samp>
<br>Postgraduate tutorials on AI in business, digital transformation, and
data-driven decision-making for 150+ students, alongside full-time engineering
at Frensei.

**Business Analytics & ML Mentor** — topmate.io
<br><samp>2025 – 2026</samp>
<br>1:1 coaching on LLM application development and technical positioning for
...
inlined as base64, because an SVG loaded through an `<img>` tag is not allowed
to fetch anything.
